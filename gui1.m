...
% Last Modified by GUIDE v2.5 17-Aug-2018 02:31:31
...
ip1 = str2num(get(hObject,'String'));
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
a = get(handles.ip1,'String');
b = get(handles.ip2,'String');
...
%store the contents of input1_editText as a string. if the string
%is not a number then input will be empty
ip2 = str2num(get(hObject,'String'));
